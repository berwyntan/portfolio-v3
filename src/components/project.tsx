...
export const Project = (props: ProjectProps) => {
  ...
  return (
    ...
    //   </Link>
    // </div>
    <div className="xs:max-w-xl card m-1 mb-5 h-96 w-full border border-gray-500 bg-gray-100 shadow-xl md:ml-2 md:max-w-md lg:max-w-xs">
      <figure className="h-60">
        <img src={preview} alt="Shoes" />
      </figure>
